...
<?php
	if ($_SERVER['REQUEST_METHOD'] =='POST') {
		$equipmentInsert   = $eqmt->equipmentInsert($_POST);
	}
?>
                            ...
                            <div class="card-body">
                                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
	                                <div class="form-header orange accent-2">
	                                    <h3><i class="fa fa-plus"></i> ADD EQUIPMENT</h3>
	                                </div>
	                                ...
	                                <div class="form-group">
										...
										<input type="text" class="form-control" id="equipment_name" name="equipment_name" placeholder="Equipment Name">
									</div>

									<div class="form-group">
										<label for="quipment_quantity"><b>Equipment Quantity</b></label>
										<input type="text" class="form-control" id="quipment_quantity" name="quipment_quantity" placeholder="Equipment Quantity">
									</div>
