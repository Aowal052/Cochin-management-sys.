...
<?php
    if ($_SERVER['REQUEST_METHOD'] =='POST' && isset($_POST['notice_add'])) {
      $notice_edit = $ntc->notice_edit($_POST,$_FILES,$notice_id);
    }
?>
...
<?php
    $get_notice_by_id = $ntc->get_notice_by_id($notice_id);
    if ($get_notice_by_id) {
    $result= $get_notice_by_id->fetch_assoc();
          ...
          <div class="row">
            ...
            <div class="col-md-4 mb-4 mt-4">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="notice_edit.php?notice_id=<?php echo $result['notice_id']; ?>" method="post" enctype="multipart/form-data">
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="notice_title" name="notice_title" placeholder="Write title" value="<?php echo $result['notice_title']; ?>">
                          </div>

                          <div class="form-group">
                            <label for="notice_description"><b>Notice Description</b></label>
                            <input type="text" class="form-control" id="notice_description" name="notice_desc" placeholder="Describe hare" value="<?php echo $result['notice_desc']; ?>">
                          </div>

                          <div class="form-group">
                            <label for="notice_image"><b>Notice Image</b></label>
                            <input type="file" class="form-control" id="notice_image" name="notice_image" placeholder="Image">

                            <img src="<?php echo $result['notice_image']; ?>" alt="" style="width: 100px">
                          </div>
