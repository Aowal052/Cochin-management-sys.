...
<?php
    if ($_SERVER['REQUEST_METHOD'] =='POST' && isset($_POST['update'])) {
        $user_auth_edit = $mktr->main_marketer_edit($_POST,$user_auth_id);
    }
      ...
      <div class="row">
                    ...
                    <div class="col-md-12 mb-4 mt-4">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                              <form action="marketer_main_edit.php?user_auth_id=<?php echo $result['user_auth_id'] ?>" method="post">
                                  ...
                                  <div class="text-center mt-4">
                                      <button class="btn btn-orange btn-lg waves-effect waves-light" name="update">UPDATE</button>
                                  </div>
